        # Grma: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/grma.git

        ## Objective

        GRMA (Generalised Random-effects Meta-Analysis) v10.0 is a comprehensive framework for flexible random-effects modelling, extending standard methods to handle complex dependence structures.
        ...
        - Code: https://github.com/mahmood726-cyber/grma.git
        - Dashboard: https://mahmood726-cyber.github.io/grma/
